...
if (isset($_GET['id'])) {
    ...
    echo "ID de emrpesa no especificado.";
    exit();
}
    ...
    <h1 class="mt-5">Editar Empresa</h1>
        <form action="actualizar_empresa.php" method="post">
            ...
            <div class="form-group">
                <label for="txt_razonsocial">Razón Social:</label>
                <input type="text" class="form-control" id="txt_razonsocial" name="txt_razonsocial" value="<?php echo $empresa['razon_social']; ?>">
            </div>
            <div class="form-group">
